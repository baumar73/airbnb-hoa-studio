...
try {
  ...
  console.log('workerd integration OK: explicit import, isolated encrypted records, concurrent updates, stale-write rejection, chunked immutable archive, no public access');
