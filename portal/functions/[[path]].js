...
const HOME_FAQ = [
  ...
  ['Who pays the fee and how?',
   'The HOA application/background-check fee is the tenant’s responsibility and is stated in the Airbnb listing. Paper-route applicants pay by check or money order only, payable to the association with the unit, your name and the stay dates noted; a credit-card or online option is offered through Tenant Evaluation for online-route applicants. Never pay twice: if you already paid, ask the application service or association to trace that payment.'],
  ['Can more than one form be required for my application?',
   'Yes. Besides the core lease package, the association may request a separate supplementary form (for example a Tenant Check / Background Check form). When it does, it appears on your page as its own outstanding item and is only cleared after the association confirms it.'],
  ['What exactly does the laundry / washer & dryer situation look like?',
   'The unit is advertised with an in-unit washer and dryer. If you rely on laundry in the unit, confirm the equipment for your exact stay; amenity wording can lag a unit change. This portal only states verified property facts.'],
  ['Are pets allowed?',
